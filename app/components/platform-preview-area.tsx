    ...
    <section className={platformPreviewStyles["platform_preview_section"]}>
      <div className={platformPreviewStyles["platform_preview_top"]}>
        ...
        <div className={platformPreviewStyles["flower_icon"]}>
          ...
          >
            <path
              d="M4 132.679C4 136.254 5.97238 134.867 8.66667 138.235C23.6084 156.912 29.4431 183.442 31.5556 206.679C33.3689 226.626 34.5335 204.558 37.7778 196.679C47.958 171.956 61.8089 164.514 84 152.679"
              stroke="#E18C3D"
              stroke-width="8"
              stroke-linecap="round"
            />
            <path
              d="M40.0002 216.679C31.9951 215.679 46.6272 175.594 48.0002 169.568C57.0952 129.651 56.0253 104.763 44.0002 64.6792"
              stroke="#E18C3D"
              stroke-width="8"
              stroke-linecap="round"
            />
            <path
              d="M50.9998 138.679C54.4429 137.696 46.7753 127.162 45.9443 126.124C41.2111 120.207 34.9124 115.894 30.4443 109.679C26.434 104.102 24.1108 97.4563 22.611 90.7904C20.4333 81.1118 21.3767 67.2847 26.4443 58.6793C33.6577 46.4302 42.3206 35.8762 47.9998 22.5682C48.1279 22.2682 55.8955 -3.2158 51.3332 6.01263C44.4247 19.9865 41.8325 35.2334 48.9998 49.5682C55.3073 62.1832 70.8887 75.0597 70.8887 89.7904C70.8887 99.1941 63.1401 105.692 59.2221 113.679C56.1759 119.889 59.5928 133.811 49.9998 131.679"
              stroke="#E18C3D"
              stroke-width="8"
              stroke-linecap="round"
            />
